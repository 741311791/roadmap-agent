...
export class ContentManagementService {
     ...
     * @throws ApiError
     */
    public static modifyTutorialApiV1RoadmapIdConceptsConceptIdTutorialModifyPost({
        roadmapId,
        conceptId,
        requestBody,
    }: {
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/{roadmap_id}/concepts/{concept_id}/tutorial/modify',
            path: {
                'roadmap_id': roadmapId,
                'concept_id': conceptId,
            },
     ...
     * @throws ApiError
     */
    public static modifyResourcesApiV1RoadmapIdConceptsConceptIdResourcesModifyPost({
        roadmapId,
        conceptId,
        requestBody,
    }: {
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/{roadmap_id}/concepts/{concept_id}/resources/modify',
            path: {
                'roadmap_id': roadmapId,
                'concept_id': conceptId,
            },
