...
import learnerProfile from '../../examples/learner_profile.json';

// Color mapping for technology badges - unified to Design System
const getTechColor = (tech: string) => {
    const techLower = tech.toLowerCase();
    // Use Sage for primary tech
    if (techLower.includes('python') || techLower.includes('fastapi') || techLower.includes('pydantic')) {
    ...
    return (
        <div className="space-y-3">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-sage-50 via-background to-background rounded-2xl border border-sage-200 p-4 shadow-sm">
                <div className="absolute top-0 right-0 w-32 h-32 bg-sage-100/50 rounded-full blur-3xl"></div>
            ...
            <div className="bg-card rounded-2xl border border-border p-4 shadow-sm">
                ...
                <div className="flex flex-wrap gap-1.5">
                    {learnerProfile.key_technologies.map((tech, index) => (
                        <span
                            key={index}
            ...
            <div className="bg-card rounded-2xl border border-border p-4 shadow-sm">
                ...
                <div className="mb-3">
                    ...
                    <p className="text-xs text-muted-foreground mb-1.5">10 hours per week · 4-6 months</p>
                    <div className="w-full bg-muted rounded-full h-1.5 overflow-hidden">
                        <div className="bg-sage h-full rounded-full" style={{ width: '65%' }}></div>
                    </div>
                    <p className="text-[10px] text-muted-foreground mt-1">Medium intensity</p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-[10px] text-muted-foreground leading-relaxed">
                        {learnerProfile.difficulty_profile}
                    </p>
                </div>
            </div>
            ...
            <div className="bg-card rounded-2xl border border-border p-4 shadow-sm">
                ...
                <div className="space-y-2">
                    {learnerProfile.recommended_focus.map((focus, index) => (
