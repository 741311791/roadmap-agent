...
4.提供伴学模式和导学模式，伴学模式中伴学导师智能Agent会自动捕捉当前学习的内容，并采用生活化类比的方式为用户解答一切相关问题，降低理解门槛，对看起来高大上的知识点祛魅，并可以根据用户需求修改路线图的结构、教程内容、测验题目、学习资源推荐；导学模式中导学导师智能Agent会采用先进的快速学习理念，通过过实践来学习，允许你犯错，它会耐心纠正错误，并重复这个过程直至用户解决某个特定的需求
